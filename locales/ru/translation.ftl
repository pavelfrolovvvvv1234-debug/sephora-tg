...
button-software-dev = 💻 Разработка ПО
button-software-dev-discuss = 💬 Обсудить проект
button-partner-integration = 💱 Моментальный Криптообменник
button-partner-exchange-bot = 💱 Перейти в бот-обменник
...
sorting-by-balance = Сортировать по: Баланс
...
ticket-type-software_dev_request = 💻 Заявка на разработку ПО
...
admin-referrals-vds-menu-title = Выберите тип VDS для реферального процента:
admin-referrals-dedicated-menu-title = Выберите тип Dedicated для реферального процента:
